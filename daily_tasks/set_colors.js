...
function set_colors(bg_color, container_color, task_color) {
    ...
    document.getElementById("simple_checklist").style.backgroundColor = container_color;
    document.getElementById("complex_checklist").style.backgroundColor = container_color;
