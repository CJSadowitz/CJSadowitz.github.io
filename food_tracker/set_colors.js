...
function set_colors(bg_color, container_color, task_color) {
    ...
    document.getElementById("custom_food_item").style.backgroundColor = container_color;
    document.getElementById("preset_food_search").style.backgroundColor = container_color;
    document.getElementById("counts").style.backgroundColor = container_color;
    document.getElementById("add_item_to_db").style.backgroundColor = container_color;
